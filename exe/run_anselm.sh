...
#     -l cpu_turbo_boost=0 -v NB_NODES=1,MAX_CORES=4 ./measures_miniFEM.sh

qsub -q qexp -l select=1:ncpus=16:mpiprocs=4:cpu_freq=24,walltime=01:00:00 \
     -l cpu_turbo_boost=0 -v NB_NODES=1,MAX_CORES=16 ./measures_miniFEM.sh
